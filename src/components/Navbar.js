...
const Navbar = () => {
    ...
    return (
        <nav className="flex justify-between items-center my-5 mx-auto md:grid md:grid-cols-2 md:my-10">
        ...
        <div className="text-right">
            <Link to='/articles' className="ml-2.5 md:ml-5 font-normal pb-2 border-b-3 border-transparent hover:border-white">সব প্রবন্ধ</Link>
            <Link to='/issues' className="ml-2.5 md:ml-5 font-normal pb-2 border-b-3 border-transparent hover:border-white">সকল সংখ্যা</Link>
